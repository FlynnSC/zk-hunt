...
export interface JungleEnterVerifierInterface extends utils.Interface {
  functions: {
...
export interface JungleEnterVerifier extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: JungleEnterVerifierInterface;
